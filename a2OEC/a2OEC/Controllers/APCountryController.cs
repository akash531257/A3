...
{
    public class APCountryController : Controller
    {
        private readonly OECContext _context;

        public APCountryController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: APCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: APCountry/Create
